...
// Include functions
int run(const std::string& bam_fp, const std::string& ref_fp, const std::string& snps_fp, const std::string& outdir, const std::string& region, const std::string& chr_cov, const std::string& pfb_fp);
