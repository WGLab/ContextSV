...
class CNVCaller {
    private:
        int window_size = 20000;  // Window size (bases) for calculating the Log R Ratio
        int align_start = -1;
        int align_end   = -1;
    ...
    public:
        ...
        RegionCoverage getMeanCoverage(std::string input_filepath, char* chr, int start_pos=1, int end_pos=1);
